...
urlpatterns = [
    ...
    path(
        "produce/<int:pk>/",
        ProduceRetrieveUpdateDestroyView.as_view(),
        name="produce-detail",
    ),
    path(
        "produce/livestock/",
        LivestockProduceListView.as_view(),
        name="livestock-produce-list",
    ),
    ...
    path(
        "stores/check-capacity/",
        CheckStoreCapacityView.as_view(),
        name="check-store-capacity",
    ),
    path("storages/", StorageListCreateView.as_view(), name="storage-list-create"),
    path(
        "storages/<int:pk>/",
        StorageRetrieveUpdateDestroyView.as_view(),
        name="storage-retrieve-update-destroy",
    ),
    path(
        "storages/check-capacity/",
    ...
    path(
        "tools/<int:pk>/",
        ToolRetrieveUpdateDestroyView.as_view(),
        name="tool-retrieve-update-destroy",
    ),
    path(
